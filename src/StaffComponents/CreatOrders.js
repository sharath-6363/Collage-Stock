...
export default function CreatOrders() {
    ...
    return (
      <div>
        ...
        {showCustomerPopup && (
          <div className="popup">
            <div className="popup-content">
              <span className="close text-danger fs-2 pointer-event" onClick={toggleCustomerPopup}>&times;</span>
        ...
        {showProductPopup && (
          <div className="popup">
            <div className="popup-content">
              <span className="close text-danger fs-2 pointer-event" onClick={toggleProductPopup}>&times;</span>
