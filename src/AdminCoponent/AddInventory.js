...
import "../AllCss/addinventory.css";
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        alert("An error occurred while fetching Item. Please try again later.");
      }
    };
    fetchProducts();
  }, []);
  ...
  return (
    <div>
      <div className="container">
        ...
        <h3 className="text-center text-white p-2 mt-2 rounded-5" style={{ backgroundColor: "#A0153E" }}>Add Inventory</h3>
